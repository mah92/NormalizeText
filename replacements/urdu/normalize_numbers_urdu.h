// normalize_numbers_urdu.h
//Besm ALLAH
//Test by: 
// g++ -x c++ -DURDU_NUMBER_CONVERTER_ENABLE_TESTS -include normalize_numbers_urdu.h -o test_program /dev/null && ./test_program

#ifndef URDU_NUMBER_CONVERTER_H
#define URDU_NUMBER_CONVERTER_H
...
// ==================== Test Suite ====================
#ifdef URDU_NUMBER_CONVERTER_ENABLE_TESTS
...
inline void run_tests() {
    ...
    std::vector<TestCase> tests = {
        ...
        {"5", "پانچ", false},
        {"12", "بارہ", false},
        {"123", "ایک سو تئیس", false},
        {"1200", "ایک ہزار دو سو", false},

        // Decimal numbers
        {"12.34", "بارہ اعشاریہ تین چار", false},
        {"0.5", "صفر اعشاریہ پانچ", false},
        {".75", "صفر اعشاریہ سات پانچ", false},

        // Mixed text and numbers
        {"The code is 1234", "The code is ایک ہزار دو سو چونتیس", false},
        {"Call 555-1234", "Call پانچ سو پچپن - ایک ہزار دو سو چونتیس", false},
        {"number 09123456789", "number صفر، نو، ایک، دو، تین، چار، پانچ، چھ، سات، آٹھ، نو", false},

        // Edge cases
        {"", "", false}, // Empty input
        {"abc", "abc", false}, // No numbers
        {"ab.c", "ab.c", false}, // No numbers
        {"v8a", "v آٹھ a", false}, // Glued
        {"123..45", "ایک سو تئیس .. پینتالیس", false}, // Invalid number
        {"123,456,789", "بارہ کروڑ چونتالیس لاکھ چھپن ہزار سات سو نواسی", false} // With separators
    };
...
#endif // URDU_NUMBER_CONVERTER_ENABLE_TESTS
