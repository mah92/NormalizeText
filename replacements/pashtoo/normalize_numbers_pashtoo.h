// normalize_numbers_pashtoo.h
//Besm ALLAH
//Test by: 
// g++ -x c++ -DPASHTOO_NUMBER_CONVERTER_ENABLE_TESTS -include normalize_numbers_pashtoo.h -o test_program /dev/null && ./test_program

#ifndef PASHTOO_NUMBER_CONVERTER_H
#define PASHTOO_NUMBER_CONVERTER_H
...
// ==================== Test Suite ====================
#ifdef PASHTOO_NUMBER_CONVERTER_ENABLE_TESTS
...
inline void run_tests() {
    ...
    std::vector<TestCase> tests = {
        ...
        {"5", "پنځه", false},
        {"12", "دولس", false},
        {"123", "یوسل درې ویشت", false},
        {"1200", "زر او دوه سوه", false},

        // Decimal numbers
        {"12.34", "دولس اعشاریه درې څلور", false},
        {"0.5", "صفر اعشاریه پنځه", false},
        {".75", "صفر اعشاریه اووه پنځه", false},

        // Mixed text and numbers
        {"The code is 1234", "The code is زر درې سوه څلور دېرش", false},
        {"Call 555-1234", "Call پنځه سوه پنځه پنځوس - زر درې سوه څلور دېرش", false},
        {"number 09123456789", "number صفر، نه، یو، دوه، درې، څلور، پنځه، شپږ، اووه، اته، نهه", false},

        // Edge cases
        {"", "", false}, // Empty input
        {"abc", "abc", false}, // No numbers
        {"ab.c", "ab.c", false}, // No numbers
        {"v8a", "v اته a", false}, // Glued
        {"123..45", "یوسل درې ویشت .. پنځه څلوېښت", false}, // Invalid number
        {"123,456,789", "یوسل درې ویشت میلیونه، څلور سوه شپږ پنځوس زره، اووه سوه نهه اتیا", false} // With separators
    };
...
#endif // PASHTOO_NUMBER_CONVERTER_ENABLE_TESTS
...
#endif // PASHTOO_NUMBER_CONVERTER_H
